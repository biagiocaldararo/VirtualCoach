...
lista1 = ["IAGO FALQUE", "BASTOS", "DODO'", "FELIPE", "PATRIC", "SAMIR", "WALLACE", "HERNANES", "SUSO", "EL SHAARAWY", "EWANDRO", "MATOS", "SIMY", "ALEX SANDRO", "JOAO MARIO", "JOAO PEDRO", "JUAN JESUS", "DA COSTA", "MATHEUS PEREIRA", "LUIZ ADRIANO", 'RUBINHO', 'CARLAO', 'LEANDRINHO']
